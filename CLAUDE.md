...
```mermaid
graph TD
  fc5d232e["ERC-721 NFT"]
  b3d0eeb8["Frontend"]
  b2dbd482["Wallet Auth"]
  b3d0eeb8 --> b2dbd482
  fc5d232e --> b3d0eeb8
```
...
|-----------|------|----------|-------------|
| ERC-721 NFT | `erc721-stylus` | contracts | Modify this ERC-721 Stylus NFT contract to implement a Course Completion Certifi... |
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--fc5d232e.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--b3d0eeb8.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--b2dbd482.md`
...
| `NEXT_PUBLIC_APP_NAME` | Application name displayed in wallet dialogs | No | CertiChain |
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--fc5d232e.md)
- [Frontend](.nskills/components/frontend-scaffold--b3d0eeb8.md)
- [Wallet Auth](.nskills/components/wallet-auth--b2dbd482.md)
