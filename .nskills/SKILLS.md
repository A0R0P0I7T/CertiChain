...
## Premium Library Skills

These advanced resource skills have been migrated to the local project for quick reference and enhanced development capabilities:

- **[Rust Professional](file:///.nskills/library/rust-pro.md)**: Advanced Rust patterns and Stylus-specific optimization guidelines.
- **[NFT Standards](file:///.nskills/library/nft-standards.md)**: Deep dive into ERC-721, ERC-1155, and metadata best practices.
- **[Web3 Testing](file:///.nskills/library/web3-testing.md)**: Comprehensive testing strategies for contracts and dApps.
- **[Solidity Security](file:///.nskills/library/solidity-security.md)**: Security patterns and vulnerability prevention.
- **[Next.js Best Practices](file:///.nskills/library/nextjs-best-practices.md)**: Modern frontend patterns for blockchain interfaces.
